...
client = MultiServerMCPClient(
    {
        ...
        "weather": {
            ...
            "command": r"e:\Downloads\Ai_2\TripMate\.venv\Scripts\python.exe",
...
def extract_destination(query: str) -> str:
    prompt = f"""
Extract the primary destination city to use for a live weather lookup.

If the request names only a country, return its most likely arrival or base city
for this itinerary. If it names multiple cities, return the first destination city.
